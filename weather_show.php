...
<div class="container">
    <div class="row">
        ...
        while ($city_row = mysqli_fetch_array($city_result)) {
            ...
            $history = "select * from weather_history WHERE city_id=" . $city_row[0] . " and email='$email' and date='$dt'";
            //echo $history;
            $history_result = mysqli_query($conn, $history);
            if (mysqli_num_rows($history_result) <= 0) {
                $temp = $json_data->main->temp - 273.15;
                $insert = "insert into weather_history VALUES (NULL ,$city_row[0],'" . $email . "','" . $json_data->weather[0]->main . "','" . $json_data->weather[0]->description . "','" . $temp . "','" . $json_data->wind->speed . "','" . $json_data->main->pressure . "','" . $json_data->main->humidity . "','" . $dt . "','" . $tym . "','" . $icon . "','" . $city_row['city_id'] . "')";
               // echo $insert;
            ...
            <div class="row">
                ...
                <div class="col-sm-12 text-right">
                    <br><br>
                    <a href="fbshare.php?q=<?php echo $city_row['city_name'] ?>" target="_blank"><input type="button" class="btn btn-primary" value="Share on Facebook/Twitter"></a></div>
            </div><br><br>
